...
st.title("Travily Account Creator - V1.3")

# Validate the uploaded file to ensure it has the correct columns for Travily
def validate_travily_file(df):
    required_columns = ["Account Status", "Owner ID", "First Name", "Last Name", "Billing Country", "Email", "Mobile"]
...
# Function to transform data for Travily CSV
        ...
        if operation == "Transform Data for Primary CSV":
            ...
            if primary_transformed_df is not None:
                ...
                st.download_button(
                    ...
                    data=primary_csv,
                    file_name="primary_member_data.csv",
                    mime="text/csv",
                )
            ...
            if travily_transformed_df is not None:
                ...
                st.download_button(
                    ...
                    data=travily_csv,
                    file_name="travily_member_data.csv",
                    mime="text/csv",
                )
